...
def yields(request):
    ...
    if "pdf" in request.POST:
        ...
        yields_datas = [[getattr(yields0, title.lower().replace(" ", "_")) for title in titles_list] for yields0 in
                        yields_list]
...
def plantations(request):
    ...
    if "pdf" in request.POST:
        ...
        plantations_data = [[getattr(plantations0, title.lower().replace(" ", "_")) for title in titles_list] for
                            plantations0 in plantations_list]
...
def nurseries(request):
    ...
    if "pdf" in request.POST:
        ...
        nurseries_data = [[getattr(nursery0, title.lower().replace(" ", "_")) for title in titles_list] for nursery0 in
                          nurseries_list]
