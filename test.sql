...
`module_id_id` bigINTEGER DEFAULT NULL,
`trainer_id_id` bigINTEGER DEFAULT NULL,
PRIMARY KEY (`id`),
FOREIGN KEY (`trainer_id_id`) REFERENCES `dashboard_trainer` (`id`),
FOREIGN KEY (`module_id_id`) REFERENCES `dashboard_trainingmodule` (`id`)
);
...
CREATE INDEX `dashboard_training_module_id_id` ON `dashboard_training` (`module_id_id`);
CREATE INDEX `dashboard_training_trainer_id_id` ON `dashboard_training` (`trainer_id_id`);
